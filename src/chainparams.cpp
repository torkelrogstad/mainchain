...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1296688604, 1697995136, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x000000008471b2e26f1555967121648d491cb6c71a27ee8b11e68b485ba52054"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1691106680, 5, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x5903be44fe2720c789a92005e8de68fc1c10fccf5db96d9c5a3d17f958f2a853"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
