...
{
    const auto defaultBaseParams = CreateBaseChainParams(CBaseChainParams::DRIVENET);
    const auto testnetBaseParams = CreateBaseChainParams(CBaseChainParams::TESTNET);
    const auto defaultChainParams = CreateChainParams(CBaseChainParams::DRIVENET);
    ...
    while (!fLoaded && !fRequestShutdown) {
        ...
        do {
            try {
                ...
                popreturndb.reset();
                popreturndb.reset(new OPReturnDB(nOPReturnCache, false, fReset));
